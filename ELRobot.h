...
#define NONE			0
#define BEEP			8
#define c				60		// entspricht 264Hz -> c'
#define d				53 // entspricht d'
#define e				47 // entspricht e'
#define f				44 // entspricht f'
#define g				39 // entspricht g'
#define a				35 // entspricht a'
#define h				31 // entspricht h'
#define c_2				((c/2)) // entspricht c''
...
void timer_beep_melodie(void)
{
	char state1 = 2, state2 = 0;
	while (state1--) {
		for (state2 = 0; state2 < 3; state2++) {
			timer_beep_tone(g);
			_delay_ms(250);
			timer_beep_tone(a);
			_delay_ms(125);
	...
	timer_beep_tone(NONE);
	_delay_ms(8000);
	for (state1 = 0; state1 < 4; state1++) {
		timer_beep_tone(g);
		_delay_ms(250);
		timer_beep_tone((h+c_2)/2);
		_delay_ms(250);
		timer_beep_tone(NONE);
		_delay_ms(250);
		timer_beep_tone((f+g)/4);
		...
		timer_beep_tone(f/2);
		_delay_ms(750);
		timer_beep_tone((h+a)/2);
		_delay_ms(250);
		timer_beep_tone((c_2+d/2)/2);
		_delay_ms(250);
		timer_beep_tone(d/2);
		_delay_ms(750+750);
		timer_beep_tone((a+h)/2);
